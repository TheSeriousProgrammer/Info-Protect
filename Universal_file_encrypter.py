...
try:
    #global file
    file1=open("univlog01.dat",'rb')
    file1.close()
    file1=open("univlog01.dat",'ab')
except IOError:
    file1=open("univlog01.dat",'ab')
...
while True :
    ...
    if choice==1 :
        try:
            ...
            pickle.dump(enc_file.password,file1)
        ...
        try:
            ...
            pickle.dump(dec_file.password,file1)
